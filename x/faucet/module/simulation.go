...
import (
	...
	faucetsimulation "testchain/x/faucet/simulation"
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	simState.AppParams.GetOrGenerate(opWeightMsgRequest, &weightMsgRequest, nil,
		func(_ *rand.Rand) {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgRequest,
		faucetsimulation.SimulateMsgRequest(am.accountKeeper, am.bankKeeper, am.keeper),
	))
